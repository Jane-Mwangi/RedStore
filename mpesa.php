...
if ( isset($_POST['mobilenum'])){
    $pemail = $_POST['mobilenum'];
    $cname = $_POST['cname'];
    $amount= $_POST['amount'];


    $query ="INSERT INTO M-Pesa(mobilenum, cname, amount) VALUES ( '  $mobilenum',' $cname',' $amount');";
            ...
            <div class="row">
                ...
                <form method="POST">
                    <div id="box" >
                        ...
                        <form method="POST" >
                            <div  class="title text-center">M-pesa</div> 

                            <label for="mobilenum">Mobilenum</label>
                            <input id="text" type="text"  name="mobilenum" placeholder="+254-xxx-xxx-xxxx">
