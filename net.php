...
if ( isset($_POST['cardnum'])){
    $pemail = $_POST['cardnum'];
    $cname = $_POST['cname'];
    $amount= $_POST['amount'];


    $query ="INSERT INTO Net Banking(cardnum, cname, amount) VALUES ( '  $cardnum',' $cname',' $amount');";
            ...
            <div class="row">
                ...
                <form method="POST">
                    <div id="box" >
                        ...
                        <form method="POST" >
                            <div  class="title text-center">Net Banking</div> 

                            <label for="mobilenum">Card Number</label>
                            <input id="text" type="text"  name="cardnum" placeholder="xxxx-xxxx-xxxx-xxxx">
